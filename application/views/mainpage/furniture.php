  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="">Furniture<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="gadgets">Gadgets Items</a></li>
            <li><a href="clothings">Clothings Items</a></li>
...
<div class="container">
  ...
  <img src="<?php echo base_url();?>/assets/design/furnihead.png" style="margin-left: 10px" ></img>
  </div>
  <div class="container row">
...
<script type="text/javascript">
  ...
  function showFurnit() {
      $.ajax({
          type: 'post',
          url: '<?php echo base_url() ?>/main/getFur',
          async: false,
          dataType: 'json',

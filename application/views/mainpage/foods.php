  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="">Food<span class="caret"></span></a>
...
<div class="container">
  ...
  <img src="<?php echo base_url();?>/assets/design/foodhead.png" style="margin-left: 10px" ></img>
  </div>
  <div class="container row">
...
showFood();
 ...
 function showFood() {
      $.ajax({
          type: 'post',
          url: '<?php echo base_url() ?>/main/getFoods',
          async: false,
          dataType: 'json',
